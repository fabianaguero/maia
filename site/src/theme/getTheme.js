export function getTheme(isDark) {
  return {
    ...
    showcaseOuter: isDark
      ? "border-white/10 bg-gradient-to-br from-slate-950 to-slate-900 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_30px_90px_rgba(0,0,0,0.45)]"
      : "border-slate-200 bg-gradient-to-br from-white to-slate-100 shadow-[0_0_0_1px_rgba(15,23,42,0.04),0_24px_70px_rgba(15,23,42,0.08)]",
    ...
    footerGradient: isDark
      ? "bg-gradient-to-r from-cyan-400/10 via-white/[0.04] to-violet-400/10"
      : "bg-gradient-to-r from-cyan-50 via-white to-violet-50",
    primaryBtn:
      "border-cyan-300/40 bg-cyan-300/10 text-white hover:border-cyan-200/60 hover:bg-cyan-300/15",
    secondaryBtn: isDark
      ? "border-white/10 bg-white/5 text-slate-200 hover:border-white/20 hover:bg-white/10"
      : "border-slate-300 bg-white text-slate-800 hover:border-slate-400 hover:bg-slate-100",
    cardAccent: isDark
      ? "border-cyan-400/20 bg-gradient-to-br from-cyan-400/10 via-white/[0.03] to-violet-400/10"
      : "border-cyan-200 bg-gradient-to-br from-cyan-50 via-white to-violet-50",
