export const contentEn = {
    ...
    features: [
      {
        ...
        text: "The team's preferred music becomes the steady listening frame instead of generic alert noise.",
      },
      {
      ...
      },
      {
        ...
        text: "Maia adds a second perceptual channel so people can keep working and still hear what the system is doing.",
      },
      {
        title: "Replay and feedback improve the mix",
        text: "Saved replay notes can drive better monitoring presets for later sessions.",
      },
    ],
  },
  how: {
    ...
    steps: [
      {
        ...
        text: "Pick a track or playlist the team actually enjoys hearing for long stretches.",
      },
      {
      ...
      },
      {
        ...
        text: "Derive deterministic metrics, cadence, anomaly markers, and beat-aware cue routing.",
      },
      {
        title: "Monitor by ear",
        text: "Hear calm, pressure, drift, and anomalies without depending only on dashboards and constant visual scanning.",
      },
    ],
  },
  didactic: {
    ...
    patternLogicText:
      "INFO keeps the groove stable, WARN adds tension, ERROR introduces stronger hits and timbral change.",
    ...
    sonicMapping: [
      {
        label: "Stable info flow",
        sound: "Soft pulse + warm pad",
        effect: "Keeps a steady groove when the stream is healthy and predictable",
        width: "58%",
      },
      {
        label: "Warning cluster",
        sound: "Tonal lift + brighter percussion",
        effect: "Signals rising tension when bursts start to appear",
        width: "74%",
      },
      {
        label: "Error anomaly",
        sound: "Sharp hit + filter shift + denser rhythm",
        effect: "Makes disruptive events audible without watching the stream",
        width: "94%",
      },
    ],
  },
  mvp: {
    ...
    framing: [
      {
        label: "Hook",
        text: "Turn system behavior into a background mix your team can actually live with.",
      },
      {
        label: "Promise",
        text: "Add a second perceptual channel for technical teams without replacing metrics or dashboards.",
      },
      {
        label: "Proof",
        text: "Show base tracks/playlists, live tailing, process sessions, replay bookmarks, and beat-aware scheduling.",
      },
  ...
  vision: {
    ...
    cards: [
      {
        title: "Auditory monitoring first",
        text: "The product should still make sense when nobody is looking at the screen.",
      },
      {
        title: "The base bed matters",
        text: "A track or playlist sets the mood, fatigue profile, and musical continuity.",
      },
      {
      ...
      },
      {
        ...
        text: "Curated instrumental profiles instead of vague AI magic.",
      },
    ],
  },
  roadmap: {
    ...
    columns: {
      now: {
        label: "Now",
        title: "Strengthen the musical base before expanding the runtime",
        items: [
          {
            label: "01 · Deeper track and playlist prep",
            text: "Push local analysis closer to a DJ-style library workflow with stronger structure, cues, and playlist intelligence.",
          },
          {
            label: "02 · Background music-server mode",
            text: "Move from app-scoped monitoring to longer-running team listening workflows.",
          },
        ],
      },
      next: {
        ...
        items: [
          ...
          },
          {
            ...
            text: "Add denser sequencing and stronger component-level mapping.",
          },
        ],
      },
      later: {
        ...
        items: [
          {
            ...
            text: "Only later explore system-audio passthrough and broader routing outside the imported library workflow.",
          },
          {
            label: "06 · Full export and bounce pipeline",
            text: "Move beyond plan.json and preview.wav toward real export UX.",
          },
          {
            label: "07 · Listener preference profiles",
            text: "Expand curated listening modes, fatigue control, and team-specific monitoring palettes.",
          },
        ],
      },
    },
    ...
    recommendation:
      "The best path is Now → Next → Later: strengthen local musical prep and in-product monitoring first, then expand adapters and sonification, and keep virtual output as a later roadmap layer.",
  },
  footer: {
