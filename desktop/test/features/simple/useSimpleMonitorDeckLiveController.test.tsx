...
import { useSimpleMonitorDeckLiveController } from "../../../src/features/simple/useSimpleMonitorDeckLiveController";
...
describe("useSimpleMonitorDeckLiveController", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("composes reactive audio, track audio and live stream hooks", () => {
    ...
    expect(result.current.liveSuggestedBpm).toBe(132);
