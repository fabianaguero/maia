...
import { useSimpleMonitorDeckRuntime } from "../../../src/features/simple/useSimpleMonitorDeckRuntime";
...
describe("useSimpleMonitorDeckRuntime", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("assembles deck state from sub-hooks and resolves deck bpm from live stream", () => {
