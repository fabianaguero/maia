...
export function buildSimpleMonitorIdleHookArgs(input: {
  ...
  return {
    ...
    codeProjectSourceOptions: input.launchState.codeProjectSourceOptions,
    selectedCodeProjectId: input.launchState.selectedCodeProjectId,
    onSelectCodeProjectId: input.launchState.setSelectedCodeProjectId,
    tracks: input.collections.safeTracks,
    selectedSoundId: input.launchState.selectedSoundId,
